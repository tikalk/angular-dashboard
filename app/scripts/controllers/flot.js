...
angular.module('angularDashboardApp')
  .controller('FlotCtrl', ['$scope', 'FlotPageService', function ($scope, FlotPageService) {
    //Flot Line Chart
    var offset = 0;
    plot();
	...
	//Flot Pie Chart
	FlotPageService.getPieChartData().then(function(data){
    ...
    FlotPageService.getMultipleAxesLineChartData().then(function(data){
	...
	//Flot Bar Chart
	FlotPageService.getBarChartData().then(function(data){
		var barOptions = {
	        series: {
	            bars: {
	                show: true,
...
.service('FlotPageService', ['$http', '$q', function($http, $q){
	...
	this.getMultipleAxesLineChartData = function(){
		var deferred = $q.defer();
		deferred.resolve({
			oilPrices : [
	        [1167692400000, 61.05],
